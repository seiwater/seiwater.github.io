...
**Access to raw data and Rmarkdown files:** The Rmarkdown file and data used to generate this page is stored on [github](seiwater.github.io/R/2016-09-15-Filling-Missing-Data-in-Climatological-Time-Series.Rmd), and the raw data/files used in this example are stored [here] (seiwater.github.io/raw_data/fillmissdata.zip)
...
## Resources
Data used for the examples are hosted in this repository. The zipped file contains the following: *SCVWD_Daily_RainGage_ts.csv*: csv of the station precipitation data in Santa Clara County, CA; and *Station_XY_ft.csv*: csv of station Lon Lat Coordinates
